  ...
  <div class="bg-slate-800 shadow-lg rounded-lg p-6 ">
    ...
    <div class="ml-5">
        ...
        <form action="{{ route('simpanNilaiSemhas') }}" method="POST">
            ...
            <div class="mb-6">
                <label for="nilai_1" class="block mb-2 text-sm font-medium text-white dark:text-white">Kesesuaian Laporan TA dengan Proposal Penelitian (bobot 25%)</label>
            ...
            <div class="mb-6">
                <label for="nilai_2" class="block mb-2 text-sm font-medium text-white dark:text-white">Penguasaan metodologi penelitian (bobot 10%)</label>
            ...
            <div class="mb-6">
                <label for="nilai_3" class="block mb-2 text-sm font-medium text-white dark:text-white">Integritas data/hasil (bobot 20%)</label>
            ...
            <div class="mb-6">
                <label for="nilai_4" class="block mb-2 text-sm font-medium text-white dark:text-white">Hubungan data/hasil dan tujuan (bobot 10%)</label>
            ...
            <div class="mb-6">
                <label for="nilai_5" class="block mb-2 text-sm font-medium text-white dark:text-white">Kemampuan menjelaskan dan menganalisis hubungan data (bobot 10%)</label>
            ...
            <div class="mb-6">
                <label for="nilai_6" class="block mb-2 text-sm font-medium text-white dark:text-white">Teknik presentasi dan kemampuan berkomunikasi (bobot 25%)</label>

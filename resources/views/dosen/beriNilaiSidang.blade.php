...
<div class="font-lato max-w-screen-lg mx-auto">
  ...
  <div class=" flex float-right items-start justify-end">
    ...
    <div class="ml-5">
        <h2 class="text-xl font-bold mb-4">PENILAIAN SIDANG AKHIR</h2>
        ...
        <form action="{{ route('simpanNilaiSidang') }}" method="POST">
            ...
            <div> 
                ...
                <div class="mb-6">
                    <label for="nilai_1" class="font-lato block mb-2 text-sm font-medium text-white dark:text-white">Kedisiplinan (bobot 10%)</label>
                ...
                <div class="mb-6">
                    <label for="nilai_2" class="block mb-2 text-sm font-medium text-white dark:text-white">Ketekunan (bobot 5%)</label>
                ...
                <div class="mb-6">
                    <label for="nilai_3" class="block mb-2 text-sm font-medium text-white dark:text-white">Ketelitian (bobot 5%)</label>
            ...
            <div>
                ...
                <div class="mb-6">
                    <label for="nilai_5" class="block mb-2 text-sm font-medium text-white dark:text-white">Isi Laporan TA (bobot 20%)</label>
                ...
                <div class="mb-6">
                    <label for="nilai_6" class="block mb-2 text-sm font-medium text-white dark:text-white">Kesesuaian format (mengacu pada pedoman penulisan Tugas Akhir FMIPA) (bobot 5%)</label>
                ...
                <div class="mb-6">
                    <label for="nilai_7" class="block mb-2 text-sm font-medium text-white dark:text-white">Bahasa (mengikuti bahasa baku/EYD) (bobot 5%)</label>
            ...
            <div> 
                ...
                <div class="mb-6">
                    <label for="nilai_8" class="block mb-2 text-sm font-medium text-white dark:text-white">Penguasaan materi penelitian dan ilmu dasar yang telah dipelajari (bobot 30%)</label>
                ...
                <div class="mb-6">
                    <label for="nilai_9" class="block mb-2 text-sm font-medium text-white dark:text-white">Kemampuan diskusi (bobot 10%)</label>

...
<div class="min-h-screen bg-gray-100 flex flex-col justify-center py-12">
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    ...
    <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200 mt-5">
      <form class="px-5 py-7" method="POST" action="{{ route('login') }}">
        ...
        <button type="submit" class="mt-5 transition duration-200 bg-blue-700 hover:bg-blue-800 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
  ...
  <div class="w-full mx-auto text-center max-w-screen-xl p-4 items-center mt-3 text-sm font-normal text-gray-600">
            <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" type="button" class="mr-4  md:mr-6 ">2023 Copyright USK </button>   
